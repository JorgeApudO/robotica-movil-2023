...
class Movement(object):
    ...
    def aplicar_velocidad(self, speed_command: list):
        for mov in speed_command:
            ...
            angulo_real_inicial = euler_from_quaternion(
                                    (self.real_pose.orientation.x,
                                     self.real_pose.orientation.y,
                                     self.real_pose.orientation.z,
                                     self.real_pose.orientation.w))[2]
            ...
            angulo_real_final = euler_from_quaternion(
                                    (self.real_pose.orientation.x,
                                     self.real_pose.orientation.y,
                                     self.real_pose.orientation.z,
                                     self.real_pose.orientation.w))[2]
